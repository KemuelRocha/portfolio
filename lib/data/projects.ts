...
export const projects: Project[] = [
  ...
  {
    id: "6",
    title: "Agibank Produtos Web",
    description:
      "Projetos fullstack para o Agibank, incluindo gestão de carreiras, calibragem e landing pages de alta conversão, com front moderno e backend em Django.",
    highlights: [
      "Soluções para gestão de carreiras e processos internos",
      "Fluxos de calibragem com regras de negócio no backend",
      "Landing pages de alta conversão para campanhas",
      "APIs em Django com persistência em PostgreSQL",
      "SEO técnico, Core Web Vitals e analytics avançado",
    ],
    tech: [
      "Next.js",
      "TypeScript",
